---
title: "Co-organizing EnviroDataR Group Nepal, and an R training for government foresters"
date: 2025-12-17
...
The program combined hands-on coding with pre- and post-test surveys and daily quizzes to track learning, and participants left able to apply reproducible, transparent workflows to their own data collection and processing tasks. The R Consortium featured the initiative on their blog, recognizing FRTC's leadership and the wider effort to build R capacity within Nepal's forestry and environment sector.

Read the full write-up on the [R Consortium blog](https://r-consortium.org/posts/empowering-government-professionals-in-nepal-using-r-programming-for-forestry-data-analysis/).
